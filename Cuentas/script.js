...
whatsAppButton.addEventListener('click', () => {
  ...
  window.open(`https://wa.me/?text=${encodeURIComponent(buildShareText(summary))}`, '_blank', 'noopener');
  setMessage(generalMessage, 'Se abrio WhatsApp con el resumen.', 'success');
});
